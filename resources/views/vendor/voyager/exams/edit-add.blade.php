...
@section('page_header')
    ...
    @if($edit)
    <a href="{{ route('voyager.exams.order-question', $dataTypeContent->id) }}" class="btn btn-primary btn-add-new">
        <i class="voyager-list"></i> <span>Sắp xếp cấu trúc đề</span>
    </a>
    @endif
@stop
                ...
                <div class="panel panel-bordered panel-success">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="radio">
                                <li>
                                    <input type="radio" id="option-auto" name="type_create" value="auto" checked>
                                    <label for="option-auto">Tạo tự động</label>
                                    <div class="check"></div>
                                </li>
                                <li>
                                    <input type="radio" id="option-handmade" name="type_create" value="handmade">
                                    <label for="option-handmade">Tạo thủ công</label>
                                    <div class="check"></div>
                                </li>
                            </ul>
                            ...
                            @section('submit-buttons')
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary save pull-right" style="margin-top: 20px">
                                        @if($edit){{ __('voyager::generic.save') }} @else Tiếp tục @endif
                                    </button>
                                </div>
                            @stop
