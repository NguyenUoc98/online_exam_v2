...
class QuestionController extends VoyagerBaseController
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            [
                'level_id.required'         => 'Chưa chọn độ khó',
                'grade_id.required'         => 'Chưa chọn khối thi',
                'subject_id.required'       => 'Chưa chọn môn thi',
                'type_question_id.required' => 'Chưa chọn loại câu hỏi',
    ...
    public function create(Request $request)
    {
        ...
        $num_answer = $request->get('num_answer', 4) < 2 ? 2 : $request->get('num_answer', 4);

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'num_answer'));
    }
