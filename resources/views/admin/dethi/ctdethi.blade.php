...
@section('main')
    ...
    <div class="design_cauhoi">
        <a href="../../pdf/{{$dethi->id_de}}">
            <button type="button" style="background: #213351" class="btn btn-primary">Export PDF</button>
        </a>
        <a href="export">
            <button type="button" disabled="" class="btn btnthem">Export</button>
        </a>
        <a href="import">
            <button type="button" disabled="" class="btn btnthem">Import</button>
        </a>
    </div>
            ...
            <div id="home" class="tab-pane fade in active">
                ...
                <div class="container chitietdethi" id="HTMLtoPDF">
                    <div class="row head">
                        ...
                        <div class="row">
                            <div class="col-md-8 thongtindethi ">Đề thi gồm {{$dethi->socau}} câu (Từ câu hỏi 1 đến câu
                                hỏi {{$dethi->socau}})
                            </div>
                    ...
                    <div class="row noidungdethi">
                        ...
                        <div class="row ketthucdethi">
                            ...
                            <div class="col-md-12">Thí sinh không được sử dụng tài liệu. Cán bộ coi thi không giải thích
                                gì thêm.
                            </div>
                        </div>
                    </div>
                ...
                @if(count($ctdethi) ==0)
                    <form action="../randomcauhoi" method="post">
                        ...
                        <table class="table" style="font-size: 13px">
                            ...
                            <tr>
                                <td colspan="4"><h6 class="panel-title"><i class="fas fa-chalkboard-teacher"></i><b>Chọn
                                            mức độ</b></h6></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span id="tenmucdo"
                                          style="border: 1px solid #B1A8A8;padding: 7px; font-weight: bold;">Nhận biết</span>
                                </td>


                                <td colspan="2">
                                    <input type="text" class="from-control" placeholder="  Số câu" name="socau_md1"
                                           style="border-radius: 5px; height: 35px; width: 250px; border: 1px solid #4B4949"/>
                                    / {{count($mdnhanbiet)}} câu
                                    <br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span id="tenmucdo"
                                          style="border: 1px solid #B1A8A8;padding: 7px; font-weight: bold;">Thông hiểu</span>
                                </td>


                                <td colspan="2">
                                    <input type="text" class="from-control" placeholder="  Số câu" name="socau_md2"
                                           style="border-radius: 5px; height: 35px; width: 250px; border: 1px solid #4B4949"/>
                                    / {{count($thonghieu)}} câu
                                    <br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span id="tenmucdo"
                                          style="border: 1px solid #B1A8A8;padding: 7px; font-weight: bold;">Vận dụng</span>
                                </td>


                                <td colspan="2">
                                    <input type="text" class="from-control" placeholder="  Số câu" name="socau_md3"
                                           style="border-radius: 5px; height: 35px; width: 250px; border: 1px solid #4B4949"/>
                                    / {{count($mdvandung)}} câu
                                    <br>
                        ...
                        <div style="text-align:right;padding-right: 560px; padding-bottom: 20px">
                            <button type="submit" style="	background-color: #213351;color:#fff; "
                                    class="btn btn-primary">Random
                            </button> &nbsp;
                            <button type="reset" style="background-color: red; color: #fff;border: 1px solid red"
                                    class="btn btn-primary">Thoát
                            </button>
