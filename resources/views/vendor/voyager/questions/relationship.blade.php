    ...
    @if(class_exists($options->model))
        ...
        @elseif($options->type == 'hasMany')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @if($view == 'browse')
                    @php
                        $string_values = $selected_values->implode($options->label, ', ');
                    @endphp
                    ...
                    @else
                        <ul>
                            @foreach($selected_values as $selected_value)
                                <li>{!! $selected_value->{$options->label} !!} @if($selected_value->is_correct) <span class="label label-info">Đúng</span> @else <span class="label label-primary">Sai</span> @endif</li>
                            @endforeach
                        </ul>
                    @endif
                @endif
